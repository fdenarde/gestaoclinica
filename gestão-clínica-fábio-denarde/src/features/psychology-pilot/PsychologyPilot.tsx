...
export default function PsychologyPilot() {
  ...
  const visiblePatients = useMemo(() => {
    ...
    const filtered = store.patients.filter(patient => !query || [patient.name, patient.phone, patient.email || '', patient.active ? 'ativo' : 'inativo'].some(value => value.toLocaleLowerCase().includes(query)));
