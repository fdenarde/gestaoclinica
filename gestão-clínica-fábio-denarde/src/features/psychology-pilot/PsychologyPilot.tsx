...
function PatientsView({ rows, search, searchKey, setSearch, onNew, onEdit, onOpen, onOpenFinance, onDelete, onSetReview, onBulkDelete, preview }: { rows: PsychologyPatientListItem[]; search: string; searchKey: string; setSearch: (value: string) => void; onNew: () => void; onEdit: (patient: PsychologyPatient) => void; onOpen: (patient: PsychologyPatient) => void; onOpenFinance: (patient: PsychologyPatient) => void; onDelete: (patient: PsychologyPatient) => void; onSetReview: (patientIds: string[], inReview: boolean) => boolean | Promise<boolean>; onBulkDelete: (patientIds: string[]) => PsychologyBulkDeletionSummary | Promise<PsychologyBulkDeletionSummary>; preview?: PsychologyDoctoraliaPreview | null }) {
