...
test('R2C1 paciente 06 — telefone é preservado no canonical interno', () => assert.equal(getPsychologyPatientData(fixture(), 'patient-r2c1')?.patient.phone, '5527999991111'));
